...
<html lang="en-US">
  ...
  <body>
    ...
    <p>Your email was used recently to register with cloudhrm. Click {{ link_to_action('AuthController@getVerify', 'this link', array($token)) }} to verify your email address.</p>
