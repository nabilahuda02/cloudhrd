@if($medical->canDelete())
  {{ Form::open(array('id'=>'delete_form', 'method'=>'post','action'=>array('MedicalController@destroy',$medical->id))) }}
...
@if($medical->canVerify())
  {{ Form::open(array('id'=>'verify_form', 'method'=>'post','action'=>array('MedicalController@update',$medical->id))) }}
...
@if($medical->canApprove())
  {{ Form::open(array('id'=>'approve_form', 'method'=>'post','action'=>array('MedicalController@update',$medical->id))) }}
    {{ Form::hidden('_method', 'PUT')}}
...
@if($medical->canReject())
  {{ Form::open(array('id'=>'reject_form', 'method'=>'post','action'=>array('MedicalController@update',$medical->id))) }}
    {{ Form::hidden('_method', 'PUT')}}
...
@if($medical->canCancel())
  {{ Form::open(array('id'=>'cancel_form', 'method'=>'post','action'=>array('MedicalController@update',$medical->id))) }}
    {{ Form::hidden('_method', 'PUT')}}
