@if($claim->canDelete())
  {{ Form::open(array('id'=>'delete_form', 'method'=>'post','action'=>array('PayrollsController@destroy',$claim->id))) }}
...
@if($claim->canVerify())
  {{ Form::open(array('id'=>'verify_form', 'method'=>'post','action'=>array('PayrollsController@update',$claim->id))) }}
...
@if($claim->canApprove())
  {{ Form::open(array('id'=>'approve_form', 'method'=>'post','action'=>array('PayrollsController@update',$claim->id))) }}
    {{ Form::hidden('_method', 'PUT')}}
...
@if($claim->canReject())
  {{ Form::open(array('id'=>'reject_form', 'method'=>'post','action'=>array('PayrollsController@update',$claim->id))) }}
    {{ Form::hidden('_method', 'PUT')}}
...
@if($claim->canCancel())
  {{ Form::open(array('id'=>'cancel_form', 'method'=>'post','action'=>array('PayrollsController@update',$claim->id))) }}
    {{ Form::hidden('_method', 'PUT')}}
