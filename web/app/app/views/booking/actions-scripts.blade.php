@if($booking->canDelete())
  {{ Form::open(array('id'=>'delete_form', 'method'=>'post','action'=>array('RoomBookingController@destroy',$booking->id))) }}
...
@if($booking->canVerify())
  {{ Form::open(array('id'=>'verify_form', 'method'=>'post','action'=>array('RoomBookingController@update',$booking->id))) }}
...
@if($booking->canApprove())
  {{ Form::open(array('id'=>'approve_form', 'method'=>'post','action'=>array('RoomBookingController@update',$booking->id))) }}
    {{ Form::hidden('_method', 'PUT')}}
...
@if($booking->canReject())
  {{ Form::open(array('id'=>'reject_form', 'method'=>'post','action'=>array('RoomBookingController@update',$booking->id))) }}
    {{ Form::hidden('_method', 'PUT')}}
...
@if($booking->canCancel())
  {{ Form::open(array('id'=>'cancel_form', 'method'=>'post','action'=>array('RoomBookingController@update',$booking->id))) }}
    {{ Form::hidden('_method', 'PUT')}}
