@if($claim->canDelete())
  {{ Form::open(array('id'=>'delete_form', 'method'=>'post','action'=>array('GeneralClaimsController@destroy',$claim->id))) }}
...
@if($claim->canVerify())
  {{ Form::open(array('id'=>'verify_form', 'method'=>'post','action'=>array('GeneralClaimsController@update',$claim->id))) }}
...
@if($claim->canApprove())
  {{ Form::open(array('id'=>'approve_form', 'method'=>'post','action'=>array('GeneralClaimsController@update',$claim->id))) }}
    {{ Form::hidden('_method', 'PUT')}}
...
@if($claim->canReject())
  {{ Form::open(array('id'=>'reject_form', 'method'=>'post','action'=>array('GeneralClaimsController@update',$claim->id))) }}
    {{ Form::hidden('_method', 'PUT')}}
...
@if($claim->canCancel())
  {{ Form::open(array('id'=>'cancel_form', 'method'=>'post','action'=>array('GeneralClaimsController@update',$claim->id))) }}
    {{ Form::hidden('_method', 'PUT')}}
